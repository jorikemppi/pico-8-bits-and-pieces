-- sends an object to the render queue.
-- remember to use initialize_render_queue first!
...
function send_to_queue(object)
 ...
 for i=1,#object.tris do
  ...
  if ((v[2][1]-v[1][1])*(v[3][2]-v[1][2])-(v[3][1]-v[1][1])*(v[2][2]-v[1][2]))/2>0 then  
   ...
   add(rq[object.layers[i]], {v[1],v[2],v[3],object.mats[i],mat,mid(1,128,flr((tri[4][3])*mat.diffuse)+mat.ambient),depth})
